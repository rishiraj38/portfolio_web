      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="space-y-8 text-lg text-muted leading-relaxed">
            <p>
              Hi! I'm <strong className="text-foreground">Rishi</strong>, a passionate full-stack developer 
              and UI/UX enthusiast who loves creating beautiful, functional web experiences.
            </p>
            
            <p>
              With expertise in modern web technologies like React, Next.js, and Node.js, 
              I build applications that are not just visually stunning but also highly performant 
              and user-friendly.
            </p>
